...
const SettingsDelete = () => {
  ...
  return (
    <View style={[styles.settingsDelete, styles.blurRectangleLayout]}>
      <Property1Default1
      ...
      <Property1DeletePopOver
        property1DeletePopOverPosition="absolute"
        property1DeletePopOverMarginTop={-150}
        property1DeletePopOverMarginLeft={-147.5}
        property1DeletePopOverTop="50%"
        property1DeletePopOverLeft="50%"
        youllLoseYourLeft="8.54%"
