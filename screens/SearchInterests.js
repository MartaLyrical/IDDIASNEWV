...
const SearchInterests = () => {
  ...
  return (
    <View style={styles.searchInterests}>
      <Pressable
        style={styles.name}
        onPress={() => navigation.navigate("SearchResults")}
      >
        <Text style={styles.mikeFuller}>Mike Fuller</Text>
        <Image
          style={styles.nameChild}
          resizeMode="cover"
          source={require("../assets/rectangle-26120.png")}
        />
        <Text style={[styles.loremIpsumDolor, styles.loremIpsumDolorClr]}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("SearchResults")}
      >
        <Text style={styles.mikeFuller}>Nelia Campos</Text>
        <Image
          style={styles.nameChild}
          resizeMode="cover"
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("SearchResults")}
      >
        <Text style={styles.mikeFuller}>Jason Caleb</Text>
        <Image
          style={styles.nameChild}
          resizeMode="cover"
          source={require("../assets/rectangle-26122.png")}
        />
        <Text style={[styles.loremIpsumDolor, styles.loremIpsumDolorClr]}>
          Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
          nonumy eirmod tempor
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("SearchResults")}
      >
        <Text style={styles.mikeFuller}>Edson Pitra</Text>
        <Image
          style={styles.nameChild}
          resizeMode="cover"
          source={require("../assets/rectangle-26123.png")}
        />
        <Text style={[styles.loremIpsumDolor, styles.loremIpsumDolorClr]}>
          Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
          nonumy eirmod tempor
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("SearchResults")}
      >
        <Text style={styles.juliaMendes}>Julia Mendes</Text>
        <Image
          style={styles.nameChild}
          resizeMode="cover"
      ...
      />
      <Text style={[styles.searchInterests1, styles.loremIpsumDolorClr]}>
        Search - Interests
      </Text>
      <Pressable
